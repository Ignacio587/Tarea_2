...
/**
 * Clase de prueba para verificar el correcto funcionameinto del metodo invitar de la clase InvitadoExterno
 */
class InvitadoExterno_CasoNormal {
     ...
     * Se inicializan los objetos de {@link Departamento} y {@link InvitadoExterno}.
    ...
    /**
     * Prueba la funcionalidad de invitar a una {@link ReunionPresencial} a un externo particular.
    ...
    void invitar_ReunionPresencial() {
        ...
        invitacion = new Invitacion(reunionPresencial.getHoraPrevista(), invitado);
        ...
        expectedOutputBuilder.append("Invitacion para: Damaso Diosdado a la reunion de las ").append(horaReunion).append("\r\n");
    ...
    /**
     * Prueba la funcionalidad de invitar a una {@link ReunionVirtual} a un externo particular.
     * Para ello se verifica que la salida impresa en la consola por el método {@code invitar} del Empleado
     * coincida con un String esperado.
     */
    @Test
    void invitar_Virtual() {
        ...
        invitacion = new Invitacion(reunionVirtual.getHoraPrevista(), invitado);
        invitado.invitar(invitacion);
